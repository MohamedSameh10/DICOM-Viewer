...
class Ui_MainWindow(object):
    ...
    def hdragcoronal(self):
        axial_image=self.hLine2.getArrayRegion(np.flip(self.volume3d,2), self.coronalView.imageItem, axes=(1, 2))
    ...
    def hdragsagital(self):
        axial_image=self.hLine3.getArrayRegion(np.flip(self.volume3d,2), self.sagitalView.imageItem, axes=(0, 2))
        self.axialView.setImage(axial_image)
